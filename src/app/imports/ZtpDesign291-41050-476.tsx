import svgPaths from "./svg-pdci267efb";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41044_789)" id="Icon">
...
function Button3() {
  return (
    <button className="cursor-pointer h-[20px] relative shrink-0 w-[179.773px]" data-name="Button">
...
function Heading() {
  return (
    <div className="h-[28px] relative shrink-0 w-[231px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[22px] top-[0.5px] tracking-[-0.5px] whitespace-nowrap">Private Access Policy</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#ede9fe] h-[24px] relative rounded-[16777200px] shrink-0 w-[108.727px]" data-name="Text">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[13px] py-[4px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#7c3aed] text-[12px] whitespace-nowrap">Private Policy</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-[733.867px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[0.5px] whitespace-nowrap">Configure access rules and security conditions for your organization</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="h-[52px] relative shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pr-[166.133px] relative size-full">
        <Container7 />
      </div>
    </div>
  );
...
function Heading2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[842px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#101828] text-[15px] top-0 whitespace-nowrap">General Information</p>
      </div>
    </div>
  );
}
...
function D() {
  return (
    <div className="absolute h-[19.5px] left-[84.95px] top-0 w-[6.781px]" data-name="_d">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#fb2c36] text-[13px] top-px whitespace-nowrap">*</p>
    </div>
  );
}
...
function PrimitiveLabel() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[842px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#364153] text-[13px] top-px whitespace-nowrap">{`Policy Name `}</p>
        <D />
      </div>
    </div>
  );
...
function Se() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[842px]" data-name="Se">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#717182] text-[14px] whitespace-nowrap">Enter Policy Name</p>
        </div>
      </div>
...
function Container12() {
  return (
    <div className="h-[65.5px] relative shrink-0 w-[842px]" data-name="Container">
...
function Se1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[842px]" data-name="Se">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#717182] text-[14px] whitespace-nowrap">Describe what this policy does...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container9() {
  return (
    <div className="bg-white h-[225px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
...
function D1() {
  return (
    <div className="absolute h-[19.5px] left-[48.04px] top-0 w-[6.781px]" data-name="_d">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#fb2c36] text-[13px] top-px whitespace-nowrap">*</p>
    </div>
  );
}
...
function PrimitiveLabel2() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[413px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#364153] text-[13px] top-px whitespace-nowrap">{`Action `}</p>
        <D1 />
      </div>
    </div>
  );
...
function PrimitiveSpan1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[34.609px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">Allow</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[413px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[13px] py-px relative size-full">
        <PrimitiveSpan1 />
        <Icon6 />
...
function Container16() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[842px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] relative size-full">
        <Container17 />
      </div>
    </div>
  );
...
function Container15() {
  return (
    <div className="h-[137.5px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[16px] items-start pl-[28px] py-[20px] relative size-full">
        <Heading3 />
        <Container16 />
      </div>
...
function Container14() {
  return (
    <div className="bg-white h-[139.5px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container15 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Heading4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[146.023px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#101828] text-[15px] top-0 whitespace-nowrap">Source and Destination</p>
      </div>
    </div>
  );
}
...
function Bd1() {
  return <div className="absolute h-[19.5px] left-[140.02px] top-0 w-[6.781px]" data-name="Bd" />;
}
...
function PrimitiveLabel3() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[413px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#364153] text-[13px] top-px whitespace-nowrap">Source</p>
        <Bd1 />
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-[47.38px] not-italic text-[#fb2c36] text-[13px] top-px whitespace-nowrap">*</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[57.273px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">All Users</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[302px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[13px] py-px relative size-full">
        <PrimitiveSpan2 />
        <Icon7 />
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] h-[62px] items-start relative shrink-0 w-[302px]" data-name="Container">
      <PrimitiveLabel3 />
      <PrimitiveButton1 />
    </div>
  );
...
function Text10() {
  return (
    <div className="h-[18px] relative shrink-0 w-[104.875px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Identity Provider :</p>
      </div>
    </div>
  );
}
...
function Ne() {
  return (
    <div className="bg-[#e3f2fd] h-[22px] relative rounded-[8px] shrink-0 w-[120.453px]" data-name="Ne">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center overflow-clip px-[8px] py-[2px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#00a4ef] text-[12px] whitespace-nowrap">Microsoft Entra ID</p>
      </div>
    </div>
  );
}
...
function Se2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[28px] items-center min-h-px min-w-px overflow-clip relative rounded-[8px]" data-name="Se">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#717182] text-[14px] whitespace-nowrap">Search users...</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[19px] items-start relative shrink-0 w-[377px]">
      <Container21 />
      <Container22 />
    </div>
  );
...
function Bd2() {
  return <div className="absolute h-[19.5px] left-[107px] top-0 w-[6.781px]" data-name="Bd" />;
}
...
function PrimitiveLabel4() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[413px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#364153] text-[13px] top-px whitespace-nowrap">Destination</p>
        <Bd2 />
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-[74.96px] not-italic text-[#fb2c36] text-[13px] top-px whitespace-nowrap">*</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[90px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">IP/ IP Ranges</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[144px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[13px] py-px relative size-full">
        <PrimitiveSpan3 />
        <Icon9 />
...
function PrimitiveButton4() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-full" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[13px] py-px relative size-full">
          <Frame3 />
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[19px] items-start relative shrink-0 w-[413px]">
      <Container24 />
      <Container25 />
    </div>
  );
...
function PrimitiveLabel5() {
  return (
    <div className="h-[18px] relative shrink-0 w-[225.016px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#364153] text-[13px] whitespace-nowrap">Protocol</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[26.93px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">TCP</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton5() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-full" data-name="Primitive.button">
...
function Container27() {
  return (
    <div className="h-[62px] relative shrink-0 w-[113px]" data-name="Container">
...
function PrimitiveLabel6() {
  return (
    <div className="h-[18px] relative shrink-0 w-[225.016px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#364153] text-[13px] whitespace-nowrap">Ports</p>
      </div>
    </div>
  );
}
...
function Se4() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-[225.016px]" data-name="Se">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#717182] text-[14px] whitespace-nowrap">e.g., 80, 443, 8080-8090</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5db] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container28() {
  return (
    <div className="h-[66px] relative shrink-0 w-[225px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
        <PrimitiveLabel6 />
        <Se4 />
      </div>
...
function Label() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Any</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="h-[42px] relative shrink-0 w-[47.977px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <PrimitiveButton6 />
        <Label />
      </div>
...
function Container26() {
  return (
    <div className="content-stretch flex gap-[12px] h-[62px] items-center pr-[-0.008px] relative shrink-0 w-full" data-name="Container">
      <Container27 />
      <Container28 />
      <Container29 />
    </div>
...
function Text11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[130.32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#3b82f6] text-[13px] top-[0.5px] whitespace-nowrap">+Add another row</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="content-stretch flex h-[36px] items-center justify-center pl-px pr-[1.008px] py-px relative rounded-[8px] shrink-0 w-[413px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d1d5db] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Text11 />
    </div>
  );
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[413px]">
      <Frame4 />
      <Container26 />
      <Button4 />
    </div>
...
function Frame7() {
  return (
    <div className="h-[248px] relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[35px] h-full items-start relative">
        <Frame6 />
        <Frame5 />
      </div>
    </div>
...
function Container18() {
  return (
    <div className="bg-white h-[326px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container19 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Heading5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[128.336px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#101828] text-[15px] top-0 whitespace-nowrap">Device Trust</p>
      </div>
    </div>
  );
}
...
function Ne1() {
  return (
    <div className="bg-[#008236] content-stretch flex h-[20.5px] items-center justify-center overflow-clip px-[8px] py-[2px] relative rounded-[8px] shrink-0 w-[40.906px]" data-name="Ne">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] not-italic relative shrink-0 text-[11px] text-white tracking-[0.0645px] whitespace-nowrap">High</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-0 top-[0.5px]">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#101828] text-[14px] w-[317.638px]">High Trust Only</p>
      <Ne1 />
    </div>
  );
}
...
function Container34() {
  return (
    <div className="h-[20px] relative shrink-0 w-[105px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <Text12 />
      </div>
    </div>
...
function Container33() {
  return (
    <div className="h-[38px] relative shrink-0 w-[266px]" data-name="Container">
...
function Frame9() {
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[16px] relative">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] w-[227.386px]">Only devices with a high trust score are allowed access.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_41044_1331)" id="Icon">
          <path d={svgPaths.pc012c00} id="Vector" stroke="var(--stroke-0, #D4183D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d={svgPaths.p2f231d00} id="Vector_2" stroke="var(--stroke-0, #D4183D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
        <defs>
          <clipPath id="clip0_41044_1331">
...
function Text13() {
  return (
    <div className="h-[14px] relative shrink-0 w-[169.797px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[14px] left-0 not-italic text-[#364153] text-[11px] top-[0.5px] whitespace-nowrap">If not satisfied → Access Denied</p>
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="bg-[#dcfce7] h-[26px] relative rounded-[6px] shrink-0 w-[211px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center pl-[10px] relative size-full">
        <Icon12 />
        <Text13 />
      </div>
    </div>
...
function Container35() {
  return (
    <div className="h-[26px] relative shrink-0 w-[311px]" data-name="Container">
...
function Vt() {
  return (
    <div className="content-stretch flex flex-col gap-[7px] h-[122px] items-start p-px relative rounded-[10px] shrink-0 w-[403px]" data-name="vt">
...
function Ne2() {
  return (
    <div className="bg-[#e5e7eb] content-stretch flex h-[20.5px] items-center justify-center overflow-clip px-[8px] py-[2px] relative rounded-[8px] shrink-0 w-[58.648px]" data-name="Ne">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] not-italic relative shrink-0 text-[#364153] text-[11px] tracking-[0.0645px] whitespace-nowrap">Medium</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-0 top-px w-[220px]">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#101828] text-[14px] w-[309.262px]">Medium or High Trust</p>
      <Ne2 />
    </div>
  );
}
...
function Container38() {
  return (
    <div className="h-[38px] relative shrink-0 w-[324px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between px-[16px] relative size-full">
        <Container39 />
      </div>
    </div>
...
function Frame13() {
  return (
    <div className="relative shrink-0 w-[285px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pr-[16px] relative w-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] w-[233.495px]">Devices with medium or high trust scores are allowed access.</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="flex-[1_0_0] h-[30px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[14px] left-0 not-italic text-[#6a7282] text-[11px] top-[8px] w-[259.763px]">If not satisfied → Drops to Low, denied</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="bg-[#f3f4f6] h-[26px] relative rounded-[6px] shrink-0 w-[227px]" data-name="Container">
...
function Container40() {
  return (
    <div className="h-[39px] relative shrink-0 w-[266px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[16px] relative size-full">
        <Container41 />
      </div>
    </div>
...
function Ne3() {
  return (
    <div className="bg-[#e5e7eb] content-stretch flex h-[20.5px] items-center justify-center overflow-clip px-[8px] py-[2px] relative rounded-[8px] shrink-0 w-[58.648px]" data-name="Ne">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] not-italic relative shrink-0 text-[#364153] text-[11px] tracking-[0.0645px] whitespace-nowrap">Any</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-0 top-px w-[220px]">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#101828] text-[14px] w-[306.779px]">Any trust level</p>
      <Ne3 />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="relative shrink-0 w-[285px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pr-[16px] relative w-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] w-[233.982px]">{`All trust levels allowed except devices set to 'Always Deny'.`}</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="flex-[1_0_0] h-[30px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="-translate-y-1/2 absolute flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[29.5px] justify-center leading-[0] left-0 not-italic text-[#6a7282] text-[11px] top-[15.25px] w-[258.562px]">
          <p className="leading-[14px]">If not satisfied → Trust decreases, still allowed</p>
        </div>
      </div>
    </div>
  );
...
function Container45() {
  return (
    <div className="bg-[#f3f4f6] h-[26px] relative rounded-[6px] shrink-0 w-[269px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[10px] relative size-full">
        <Text17 />
      </div>
    </div>
...
function Ne4() {
  return (
    <div className="bg-[#e5e7eb] content-stretch flex h-[20.5px] items-center justify-center overflow-clip px-[8px] py-[2px] relative rounded-[8px] shrink-0 w-[58.648px]" data-name="Ne">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] not-italic relative shrink-0 text-[#364153] text-[11px] tracking-[0.0645px] whitespace-nowrap">None</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-0 top-px w-[220px]">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#101828] text-[14px] w-[307.592px]">No Trust</p>
      <Ne4 />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="relative shrink-0 w-[285px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pr-[16px] relative w-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] w-[233.495px]">Ignore TrustScore entirely. No device trust verification required.</p>
      </div>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="flex-[1_0_0] h-[30px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[14px] left-0 not-italic text-[#6a7282] text-[11px] top-[8px] w-[259.763px]">If not satisfied → No impact, checks skipped</p>
      </div>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="bg-[#f3f4f6] h-[26px] relative rounded-[6px] shrink-0 w-[250px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[10px] relative size-full">
        <Text19 />
      </div>
    </div>
...
function Frame12() {
  return (
    <div className="relative shrink-0 w-[842px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-end flex flex-wrap gap-[19px_18px] items-end relative w-full">
        <Frame10 />
        <Vt2 />
        <Vt3 />
      </div>
...
function Container31() {
  return (
    <div className="h-[1253.5px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[7px] items-start pl-[28px] py-[20px] relative size-full">
        <Container32 />
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#6a7282] text-[14px] whitespace-nowrap">{`Select the minimum trust level required. If a device's trust factors are not satisfied, consequence shown on each card applies.`}</p>
        <Frame12 />
      </div>
    </div>
  );
...
function Container30() {
  return (
    <div className="bg-white h-[372px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container31 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Text20() {
  return (
    <div className="h-[20px] relative shrink-0 w-[133.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#364153] text-[14px] top-[0.5px] whitespace-nowrap">Default Trust Profile</p>
      </div>
    </div>
  );
}
...
function Ne5() {
  return (
    <div className="bg-[#f3f4f6] h-[17px] relative rounded-[8px] shrink-0 w-[42.68px]" data-name="Ne">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center overflow-clip px-[6px] py-px relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#6a7282] text-[10px] tracking-[0.1172px] whitespace-nowrap">Active</p>
      </div>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[1056px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text20 />
        <Ne5 />
      </div>
...
function Text21() {
  return (
    <div className="h-[18px] relative shrink-0 w-[1056px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container51() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[42px] items-start relative shrink-0 w-[1017px]" data-name="Container">
      <Container52 />
      <Text21 />
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex items-end relative shrink-0 w-[789px]">
      <Container51 />
    </div>
  );
}
...
function Bd3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[46.297px]" data-name="Bd">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[23px] not-italic text-[#364153] text-[14px] text-center top-[0.5px] whitespace-nowrap">View</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="bg-white content-stretch flex h-[26px] items-center justify-center p-px relative rounded-[8px] shrink-0 w-[88px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d1d5db] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Bd3 />
    </div>
  );
...
function Frame1() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[23px] items-center relative w-full">
        <Frame />
        <Button5 />
      </div>
    </div>
...
function Container50() {
  return (
    <div className="h-[63px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#747474] border-b-[0.5px] border-solid inset-0 pointer-events-none" />
...
function Bd() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1450px] items-start left-[32px] top-[95.86px] w-[900px]" data-name="Bd">
      <Button3 />
      <Container6 />
      <Container9 />
      <Container14 />
...
function Container() {
  return (
    <div className="flex-[1_0_0] h-[1519px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <T />
        <Bd />
      </div>
...
function C() {
  return (
    <div className="bg-[#f9fafb] h-[1546px] relative shrink-0 w-full" data-name="c5">
...
function Icon17() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41044_712)" id="Icon">
...
function Icon18() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41044_706)" id="Icon">
...
function Icon19() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41044_701)" id="Icon">
...
function Union3() {
  return (
    <div className="absolute inset-[0_0.71%_1.46%_0]" data-name="Union">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.5241 28.154">
        <g id="Union">
