  ...
  const getTenantData = (): TenantData => {
    ...
    if (currentTenant.id === 'riverside') {
      ...
      if (isActivated) {
        return {
          policies,
          users: [
            { id: 1,  name: 'Dr. Maria Henderson', email: 'maria@riversidedental.com',    groups: ['HR', 'Engineering'],  endpointName: ['Maria-MacBook-Pro', 'Maria-iPhone-14'],       lastLogin: '2/2/2026, 9:15:23 AM',   ucApps: ['UC', 'THERON', 'CSE'] },
            { id: 2,  name: 'Jessica Torres',       email: 'jessica@riversidedental.com',  groups: ['Design'],             endpointName: 'Jessica-Desktop',                              lastLogin: '2/3/2026, 8:42:11 AM',   ucApps: ['UC', 'THERON'] },
            { id: 3,  name: 'Mark Stevens',         email: 'mark@riversidedental.com',     groups: ['Engineering'],        endpointName: ['Mark-Laptop', 'Mark-iPad'],                   lastLogin: '2/1/2026, 3:22:45 PM',   ucApps: ['UC', 'CSE'] },
            { id: 4,  name: 'Angela Price',         email: 'angela@riversidedental.com',   groups: ['HR'],                 endpointName: 'Angela-Surface',                               lastLogin: '2/3/2026, 7:55:10 AM',   ucApps: ['UC', 'THERON'] },
            { id: 5,  name: 'Kevin Nguyen',         email: 'kevin@riversidedental.com',    groups: ['Testing'],            endpointName: ['Kevin-Desktop', 'Kevin-Windows-Laptop'],      lastLogin: '1/28/2026, 5:30:44 PM',  ucApps: [] },
            { id: 6,  name: 'Sandra Lee',           email: 'sandra@riversidedental.com',   groups: ['HR'],                 endpointName: '—',                                            lastLogin: '—',                      ucApps: ['UC', 'CSE'] },
            { id: 7,  name: 'Brian Holloway',       email: 'brian@riversidedental.com',    groups: ['Engineering'],        endpointName: 'Brian-Windows-PC',                             lastLogin: '1/30/2026, 11:20:05 AM', ucApps: ['UC', 'THERON'] },
            { id: 8,  name: 'Tanya Okafor',         email: 'tanya@riversidedental.com',    groups: ['Design', 'Testing'],  endpointName: ['Tanya-MacBook-Air', 'Tanya-Android-Phone'],   lastLogin: '2/2/2026, 4:08:51 PM',   ucApps: ['UC', 'CSE'] },
            { id: 9,  name: 'Luis Contreras',       email: 'luis@riversidedental.com',     groups: ['Testing'],            endpointName: 'Luis-ThinkPad',                                lastLogin: '1/25/2026, 9:44:32 AM',  ucApps: [] },
            { id: 10, name: 'Rachel Pham',          email: 'rachel@riversidedental.com',   groups: ['Design'],             endpointName: '—',                                            lastLogin: '—',                      ucApps: ['UC', 'THERON', 'CSE'] },
            { id: 11, name: 'Omar Shaikh',          email: 'omar@riversidedental.com',     groups: ['Engineering'],        endpointName: ['Omar-Surface-Go', 'Omar-MacBook-Pro'],        lastLogin: '2/1/2026, 6:17:44 PM',   ucApps: ['UC', 'THERON'] },
            { id: 12, name: 'Diane Kessler',        email: 'diane@riversidedental.com',    groups: ['HR', 'Design'],       endpointName: 'Diane-Laptop',                                 lastLogin: '1/29/2026, 2:55:19 PM',  ucApps: ['UC', 'CSE'] },
          ],
          dashboardMetrics: {
            totalUsers: 12,
            activeUsers: 9,
    ...
    if (currentTenant.id === 'acme') {
      return {
        policies,
        users: [
          { id: 1,  name: 'James Whitfield',  email: 'james.whitfield@acmecorp.com',  groups: ['Engineering', 'Testing'],  endpointName: 'James-MacBook-Pro',  lastLogin: '8/12/2025, 4:09:42 PM',     ucApps: ['UC', 'THERON', 'CSE'] },
          { id: 2,  name: "Sarah O'Brien",     email: 'sarah.obrien@acmecorp.com',     groups: ['HR'],                      endpointName: 'Sarah-Windows-PC',   lastLogin: '6/16/2025, 8:03:04 AM',     ucApps: ['UC', 'THERON'] },
          { id: 3,  name: 'Lucas Fernandez',   email: 'lucas.fernandez@acmecorp.com',  groups: ['Engineering'],             endpointName: 'Lucas-Laptop',       lastLogin: '7/22/2025, 7:14:27 AM',     ucApps: ['UC', 'CSE'] },
          { id: 4,  name: 'Emily Carter',      email: 'emily.carter@acmecorp.com',     groups: ['Design'],                  endpointName: '—',                  lastLogin: '—',                         ucApps: [] },
          { id: 5,  name: 'Tom Bergmann',      email: 'tom.bergmann@acmecorp.com',     groups: ['Testing'],                 endpointName: 'Tom-Desktop',        lastLogin: '—',                         ucApps: ['UC', 'THERON'] },
          { id: 6,  name: 'Rachel Kim',        email: 'rachel.kim@acmecorp.com',       groups: ['Design', 'HR'],            endpointName: 'Rachel-Surface',     lastLogin: '—',                         ucApps: ['UC', 'THERON', 'CSE'] },
          { id: 7,  name: 'Daniel Müller',     email: 'daniel.muller@acmecorp.com',    groups: ['Engineering'],             endpointName: 'Daniel-MacBook-Air', lastLogin: '1/14/2025, 12:15:52 AM',    ucApps: ['UC', 'CSE'] },
          { id: 8,  name: 'Olivia Thompson',   email: 'olivia.thompson@acmecorp.com',  groups: ['HR', 'Testing'],           endpointName: 'Olivia-Dell-XPS',    lastLogin: '10/26/2025, 11:47:31 PM',   ucApps: [] },
          { id: 9,  name: 'Marcus Webb',       email: 'marcus.webb@acmecorp.com',      groups: ['Engineering', 'Testing'],  endpointName: 'Marcus-Mobile',      lastLogin: '12/1/2025, 4:04:06 AM',     ucApps: ['UC', 'THERON'] },
          { id: 10, name: 'Claire Dupont',     email: 'claire.dupont@acmecorp.com',    groups: ['Design'],                  endpointName: 'Claire-ThinkPad',    lastLogin: '7/6/2025, 10:49:23 PM',     ucApps: ['UC', 'CSE'] },
          { id: 11, name: 'Nathan Kowalski',   email: 'nathan.kowalski@acmecorp.com',  groups: ['HR'],                      endpointName: '—',                  lastLogin: '—',                         ucApps: ['UC', 'THERON', 'CSE'] },
          { id: 12, name: 'Priya Venkatesh',   email: 'priya.venkatesh@acmecorp.com',  groups: ['Engineering', 'Design'],   endpointName: 'Priya-MacBook-Pro',  lastLogin: '5/9/2025, 2:33:17 PM',      ucApps: ['UC', 'CSE'] },
        ],
        dashboardMetrics: {
          totalUsers: 248,
          activeUsers: 186,
    ...
    if (currentTenant.id === 'enterprise') {
      return {
        policies,
        users: [
          { id: 1, name: 'Robert Williams',    email: 'robert.williams@enterprise.com',    groups: ['Engineering'],      endpointName: 'Robert-ThinkPad-X1',  lastLogin: '2/3/2026, 11:05:42 AM' },
          { id: 2, name: 'Jennifer Lee',        email: 'jennifer.lee@enterprise.com',        groups: ['Design'],           endpointName: 'Jennifer-MacBook-Pro', lastLogin: '2/3/2026, 9:22:18 AM' },
          { id: 3, name: 'James Martinez',      email: 'james.martinez@enterprise.com',      groups: ['Testing'],          endpointName: 'James-Desktop',        lastLogin: '2/2/2026, 2:15:33 PM' },
          { id: 4, name: 'Patricia Taylor',     email: 'patricia.taylor@enterprise.com',     groups: ['HR'],               endpointName: 'Patricia-Surface-Pro', lastLogin: '2/3/2026, 8:55:12 AM' },
          { id: 5, name: 'Christopher Brown',   email: 'christopher.brown@enterprise.com',   groups: ['Engineering', 'HR'], endpointName: 'Chris-Laptop',        lastLogin: '2/1/2026, 5:42:28 PM' },
        ],
        dashboardMetrics: {
          totalUsers: 1842,
          activeUsers: 1456,
    ...
    if (currentTenant.id === 'cloud-innovations') {
      return {
        policies,
        users: [
          { id: 1, name: 'Alex Kim',       email: 'alex.kim@cloudinnovations.com',       groups: ['Engineering', 'Testing'], endpointName: 'Alex-MacBook-Pro',  lastLogin: '2/3/2026, 10:12:30 AM' },
          { id: 2, name: 'Priya Sharma',   email: 'priya.sharma@cloudinnovations.com',   groups: ['Design'],                 endpointName: 'Priya-ThinkPad',    lastLogin: '2/3/2026, 9:05:15 AM' },
          { id: 3, name: 'Marcus Johnson', email: 'marcus.johnson@cloudinnovations.com', groups: ['Engineering'],             endpointName: 'Marcus-Desktop',    lastLogin: '2/2/2026, 3:45:22 PM' },
        ],
        dashboardMetrics: {
          totalUsers: 1240,
          activeUsers: 982,
    ...
    if (currentTenant.id === 'global-services') {
      return {
        policies,
        users: [
          { id: 1, name: 'Catherine Walsh',  email: 'catherine.walsh@globalservices.com',  groups: ['HR', 'Design'],    endpointName: 'Catherine-Surface',  lastLogin: '2/3/2026, 11:22:45 AM' },
          { id: 2, name: 'Daniel Cooper',    email: 'daniel.cooper@globalservices.com',    groups: ['Engineering'],     endpointName: 'Daniel-Laptop',      lastLogin: '2/3/2026, 8:30:12 AM' },
          { id: 3, name: 'Sophia Martinez',  email: 'sophia.martinez@globalservices.com',  groups: ['Testing'],         endpointName: 'Sophia-MacBook-Air', lastLogin: '2/2/2026, 4:18:33 PM' },
        ],
        dashboardMetrics: {
          totalUsers: 560,
          activeUsers: 445,
    ...
    if (currentTenant.id === 'techstart') {
      return {
        policies,
        users: [
          { id: 1, name: 'Jake Thompson', email: 'jake@techstart.com', groups: ['Engineering', 'Design'], endpointName: 'Jake-MacBook-Pro', lastLogin: '2/3/2026, 9:45:20 AM' },
          { id: 2, name: 'Emma Davis',    email: 'emma@techstart.com', groups: ['Testing'],               endpointName: 'Emma-Laptop',      lastLogin: '2/3/2026, 8:15:10 AM' },
        ],
        dashboardMetrics: {
          totalUsers: 45,
          activeUsers: 38,
