import svgPaths from "./svg-bqyawraakq";
...
function Container3() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[85.313px]" data-name="Container">
...
function Paragraph() {
  return (
    <div className="h-[18px] relative shrink-0 w-[713.453px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#6a7282] text-[12px] top-0 whitespace-nowrap">Checks that automatic software updates are enabled on the device to ensure security patches are applied promptly.</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[38px] relative shrink-0 w-[713.453px]" data-name="Container">
...
function Button1() {
  return (
    <div className="absolute bg-[#d1d5db] content-stretch flex h-[24px] items-center left-[1074px] pl-[3px] rounded-[33554400px] top-[16px] w-[44px]" data-name="Button">
      <Text1 />
    </div>
  );
}
...
function Container() {
  return (
    <div className="h-[56px] relative shrink-0 w-[1134px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container1 />
        <Button1 />
      </div>
...
function Container6() {
  return (
    <div className="bg-[#eff6ff] h-[24px] relative rounded-[4px] shrink-0 w-[55px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#364153] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[14px] left-[28px] not-italic text-[#364153] text-[10px] text-center top-[5px] whitespace-nowrap">LOW TL</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return <div className="absolute bg-[#364153] h-[4px] left-[6.08px] rounded-[33554400px] top-[8.44px] w-[136.656px]" data-name="Container" />;
}

function Button6() {
  return <div className="absolute bg-[#364153] border-2 border-[#364153] border-solid left-[0.08px] rounded-[33554400px] size-[12px] top-[4.44px]" data-name="Button" />;
}

function Button7() {
  return <div className="absolute bg-[#364153] border-2 border-[#364153] border-solid left-[127.73px] rounded-[33554400px] size-[12px] top-[4.44px]" data-name="Button" />;
}
...
function Container10() {
  return <div className="absolute bg-white border-2 border-[#364153] border-solid left-[122.73px] rounded-[33554400px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] size-[20px] top-[0.44px]" data-name="Container" />;
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col h-[128px] items-start opacity-50 pl-[16px] pt-[6px] relative shrink-0 w-[1134px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-solid border-t inset-0 pointer-events-none" />
      <TrustEffect />
    </div>
  );
...
export default function AutoUpdateExpandedOff() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start p-px relative rounded-[8px] size-full" data-name="Auto Update expanded OFF">
