import svgPaths from "./svg-xjh5s1fmr2";
...
function Container7() {
  return (
    <div className="absolute bg-white content-stretch flex h-[32px] items-center left-0 px-[13px] py-px rounded-[8px] top-0" data-name="Container">
...
export default function ApplicationCheckExpandedOn() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start p-px relative rounded-[8px] size-full" data-name="ApplicationCheck expanded ON">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container />
      <Container5 />
    </div>
