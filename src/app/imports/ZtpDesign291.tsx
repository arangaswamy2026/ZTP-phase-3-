import svgPaths from "./svg-6dilgp2i08";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41011_2354)" id="SelectedIcon">
...
function T() {
  return (
    <div className="absolute bg-white content-stretch flex h-[64px] items-center justify-between left-0 pb-px px-[24px] top-0 w-[1476px]" data-name="T6">
...
function Text8() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[79px] not-italic text-[#6a7282] text-[14px] text-center top-[0.5px] whitespace-nowrap">Back to Access Policies</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[179.773px]" data-name="Button">
...
function Text9() {
  return (
    <div className="bg-[#ede9fe] flex-[1_0_0] h-[24px] min-h-px min-w-px relative rounded-[16777200px]" data-name="Text">
...
function Text10() {
  return (
    <div className="bg-[#16a34a] h-[22px] relative rounded-[16777200px] shrink-0 w-[60.18px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[3px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">Active</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="bg-[#f3f4f6] h-[21px] relative rounded-[6px] shrink-0 w-[53.305px]" data-name="Text">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[9px] py-[3px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#6a7282] text-[10px] tracking-[0.12px] whitespace-nowrap">Default</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="h-[24px] relative shrink-0 w-[238.211px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text9 />
        <Text10 />
        <Text11 />
...
function Sc1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[68.086px]" data-name="SC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[34.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-[0.5px] tracking-[-0.15px] whitespace-nowrap">Edit Policy</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="bg-white flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[8px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center justify-center p-px relative size-full">
        <Icon6 />
        <Sc1 />
      </div>
    </div>
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41024_21228)" id="Icon">
...
function Sc2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[61.961px]" data-name="SC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[31.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-[0.5px] tracking-[-0.15px] whitespace-nowrap">Duplicate</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[105.961px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center justify-center p-px relative size-full">
        <Icon7 />
        <Sc2 />
...
function Sc3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[42.492px]" data-name="SC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[21.5px] not-italic text-[#e7000b] text-[14px] text-center top-[0.5px] tracking-[-0.15px] whitespace-nowrap">Delete</p>
      </div>
    </div>
  );
}
...
function Button6() {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[86.492px]" data-name="Button">
...
function Container10() {
  return (
    <div className="h-[32px] relative shrink-0 w-[320.539px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Button4 />
        <Button5 />
        <Button6 />
...
function Container8() {
  return (
    <div className="h-[32px] relative shrink-0 w-[842px]" data-name="Container">
...
function Heading() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[842px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[22px] top-[0.5px] tracking-[-0.5px] whitespace-nowrap">Initial Default SIA Configuration</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-[842px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[0.5px] whitespace-nowrap">Baseline internet security and threat protection</p>
      </div>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="h-[52px] relative shrink-0 w-[842px]" data-name="Container">
...
function Container7() {
  return (
    <div className="h-[148px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start pl-[28px] pt-[24px] relative size-full">
        <Container8 />
        <Container11 />
      </div>
    </div>
...
function Container6() {
  return (
    <div className="bg-white h-[150px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
...
function Text12() {
  return (
    <div className="bg-[#dcfce7] h-[21px] relative rounded-[6px] shrink-0 w-[60.43px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#b9f8cf] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[9px] py-[3px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#008236] text-[11px] whitespace-nowrap">Enabled</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="h-[21px] relative shrink-0 w-[842px]" data-name="Container">
...
function Paragraph1() {
  return (
    <div className="h-[18px] relative shrink-0 w-[842px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#6a7282] text-[13px] top-0 whitespace-nowrap">Threats on this page are blocked by default and shown for informational purposes only, highlighting what ZTP protects on your device.</p>
      </div>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Bots / Cryptomining</p>
      </div>
    </div>
  );
}
      ...
      <div className="absolute inset-[8.33%]" data-name="Vector">
        <div className="absolute inset-[-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.8333 12.8333">
            <path d={svgPaths.p13f5b400} id="Vector" stroke="var(--stroke-0, #D1D5DB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[33.33%] left-1/2 right-1/2 top-1/2" data-name="Vector">
        <div className="absolute inset-[-25%_-0.58px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.16667 3.5">
            <path d="M0.583333 2.91667V0.583333" id="Vector" stroke="var(--stroke-0, #D1D5DB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[66.67%] left-1/2 right-[49.96%] top-[33.33%]" data-name="Vector">
        <div className="absolute inset-[-0.58px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.1725 1.16667">
            <path d="M0.583333 0.583333H0.589167" id="Vector" stroke="var(--stroke-0, #D1D5DB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          </svg>
        </div>
      </div>
    </div>
...
function PrimitiveButton() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Primitive.button">
...
function Container17() {
  return (
    <div className="h-[18px] relative shrink-0 w-[145.953px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text13 />
        <PrimitiveButton />
      </div>
...
function Container16() {
  return (
    <div className="h-[39px] relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px pl-[16px] relative size-full">
          <Container17 />
        </div>
      </div>
    </div>
...
function Text14() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Dangerous Configuration / History</p>
      </div>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="h-[18px] relative shrink-0 w-[234.547px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text14 />
        <PrimitiveButton1 />
      </div>
...
function Text15() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Dangerous 3rd Party Infrastructure</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="h-[18px] relative shrink-0 w-[239.555px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text15 />
        <PrimitiveButton2 />
      </div>
...
function Text16() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Dangerous Nameserver</p>
      </div>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="h-[18px] relative shrink-0 w-[168.727px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text16 />
        <PrimitiveButton3 />
      </div>
...
function Text17() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Malicious SSL Cert</p>
      </div>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="h-[18px] relative shrink-0 w-[139.078px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text17 />
        <PrimitiveButton4 />
      </div>
...
function Text18() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">{`Malware & Ransomware`}</p>
      </div>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="h-[18px] relative shrink-0 w-[170.492px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text18 />
        <PrimitiveButton5 />
      </div>
...
function Text19() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Malware C2</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="h-[18px] relative shrink-0 w-[95.789px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text19 />
        <PrimitiveButton6 />
      </div>
...
function Text20() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Phishing</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="h-[18px] relative shrink-0 w-[75.195px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text20 />
        <PrimitiveButton7 />
      </div>
...
function Text21() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Risky DNS Transactions</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="h-[18px] relative shrink-0 w-[169.766px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text21 />
        <PrimitiveButton8 />
      </div>
...
function Text22() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Spam / VoIP fraud / Spyware</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="h-[18px] relative shrink-0 w-[199.07px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text22 />
        <PrimitiveButton9 />
      </div>
...
function Text23() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">Other Known Bad (Community Intelligence)</p>
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="h-[18px] relative shrink-0 w-[290.688px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text23 />
        <PrimitiveButton10 />
      </div>
...
function Text24() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#364153] text-[13px] top-0 whitespace-nowrap">New Domains</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="h-[18px] relative shrink-0 w-[107.563px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text24 />
        <PrimitiveButton11 />
      </div>
...
function Container13() {
  return (
    <div className="h-[572px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[12px] items-start pl-[28px] py-[20px] relative size-full">
        <Container14 />
        <Paragraph1 />
        <Container15 />
      </div>
...
function Container12() {
  return (
    <div className="bg-white h-[574px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container13 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Heading3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[842px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#101828] text-[15px] top-0 whitespace-nowrap">{`Filtering & Exceptions`}</p>
      </div>
    </div>
  );
}
      ...
      <div className="absolute inset-[8.33%_16.67%_8.32%_16.67%]" data-name="Vector">
        <div className="absolute inset-[-5%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 14.6689">
            <path d={svgPaths.p8326c00} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function Ca() {
  return (
    <div className="bg-[#f3f4f6] relative rounded-[6px] shrink-0 size-[28px]" data-name="Ca">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Text25 />
      </div>
    </div>
...
function Text26() {
  return (
    <div className="h-[18px] relative shrink-0 w-[116.023px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Category Blocking</p>
      </div>
    </div>
  );
}
...
function Ka() {
  return (
    <div className="bg-[#dbeafe] h-[19px] relative rounded-[6px] shrink-0 w-[44.148px]" data-name="ka">
      <div aria-hidden="true" className="absolute border border-[#93c5fd] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[7px] py-[2px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#1e40af] text-[10px] whitespace-nowrap">Active</p>
      </div>
    </div>
  );
}
...
function Ho() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[36px] px-[9px] py-[4px] rounded-[6px] top-0 w-[131.523px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Adult / Pornography</p>
    </div>
  );
}
...
function Ho1() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[173.52px] px-[9px] py-[4px] rounded-[6px] top-0 w-[219.563px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">{`Gambling & Illegal Downloads (P2P)`}</p>
    </div>
  );
}
...
function Ho2() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[399.09px] px-[9px] py-[4px] rounded-[6px] top-0 w-[165.039px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">{`Malicious Sites & Phishing`}</p>
    </div>
  );
}
...
function Ho3() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[570.13px] px-[9px] py-[4px] rounded-[6px] top-0 w-[228.227px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">{`Hacking Tools & Anonymizers (VPNs)`}</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="h-[24px] relative shrink-0 w-[808px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Ho />
        <Ho1 />
        <Ho2 />
...
function Paragraph2() {
  return (
    <div className="h-[15px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Italic',sans-serif] font-normal italic leading-[15px] left-[36px] text-[#9ca3af] text-[11px] top-0 whitespace-nowrap">{`Tip: Block "Social Media" for marketing roles, block for others.`}</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="h-[117px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start pl-[17px] pr-px py-[17px] relative size-full">
        <Container43 />
        <Container44 />
        <Paragraph2 />
      </div>
      ...
      <div className="absolute inset-[45.83%_12.5%_8.33%_12.5%]" data-name="Vector">
        <div className="absolute inset-[-9.09%_-5.56%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 8.66667">
            <path d={svgPaths.p6134400} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[8.33%_29.17%_54.17%_29.17%]" data-name="Vector">
        <div className="absolute inset-[-11.11%_-10%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 7.33333">
            <path d={svgPaths.p2a9f90c0} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function Text28() {
  return (
    <div className="h-[18px] relative shrink-0 w-[128.977px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Application Blocking</p>
      </div>
    </div>
  );
}
...
function Ho4() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[36px] px-[9px] py-[4px] rounded-[6px] top-0 w-[233.305px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">{`Torrents & File Sharing (uTorrent, etc.)`}</p>
    </div>
  );
}
...
function Ho5() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[275.3px] px-[9px] py-[4px] rounded-[6px] top-0 w-[158.664px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Proxy / VPN Applications</p>
    </div>
  );
}
...
function Ho6() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[439.97px] px-[9px] py-[4px] rounded-[6px] top-0 w-[97.625px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Hacking Tools</p>
    </div>
  );
}
...
function Ho7() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[543.59px] px-[9px] py-[4px] rounded-[6px] top-0 w-[185.734px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Unauthorized Remote Access</p>
    </div>
  );
}
...
function Container45() {
  return (
    <div className="h-[94px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start pl-[17px] pr-px py-[17px] relative size-full">
        <Container46 />
        <Container47 />
      ...
      <div className="absolute inset-[12.5%_8.33%_29.17%_8.33%]" data-name="Vector">
        <div className="absolute inset-[-7.14%_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6667 10.6667">
            <path d={svgPaths.pb5eef70} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[87.5%_33.33%_12.5%_33.33%]" data-name="Vector">
        <div className="absolute inset-[-0.67px_-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.66667 1.33333">
            <path d="M0.666667 0.666667H6" id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[12.5%] left-1/2 right-1/2 top-[70.83%]" data-name="Vector">
        <div className="absolute inset-[-25%_-0.67px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.33333 4">
            <path d="M0.666667 0.666667V3.33333" id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function Text30() {
  return (
    <div className="h-[18px] relative shrink-0 w-[120.695px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#6a7282] text-[13px] top-0 whitespace-nowrap">Application Bypass</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[36px] not-italic text-[#6a7282] text-[12px] top-[0.5px] whitespace-nowrap">Use only when a trusted business app breaks due to security inspection.</p>
      </div>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Italic',sans-serif] font-normal italic leading-[16px] left-[36px] text-[#9ca3af] text-[12px] top-[0.5px] whitespace-nowrap">No application bypass rules configured.</p>
      </div>
    </div>
  );
}
...
function Container48() {
  return (
    <div className="h-[106px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start pl-[17px] pr-px py-[17px] relative size-full">
        <Container49 />
        <Paragraph3 />
        <Paragraph4 />
      </div>
      ...
      <div className="absolute inset-[8.33%_33.33%]" data-name="Vector">
        <div className="absolute inset-[-5%_-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.66667 14.6667">
            <path d={svgPaths.p1700eb00} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/2 left-[8.33%] right-[8.33%] top-1/2" data-name="Vector">
        <div className="absolute inset-[-0.67px_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6667 1.33333">
            <path d="M0.666667 0.666667H14" id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function Text32() {
  return (
    <div className="h-[18px] relative shrink-0 w-[105.188px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Domain Blocking</p>
      </div>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[36px] not-italic text-[#6a7282] text-[12px] top-[0.5px] whitespace-nowrap">Block known unsafe domains and high-risk TLDs (e.g., .xyz, .top).</p>
      </div>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Italic',sans-serif] font-normal italic leading-[16px] left-[36px] text-[#9ca3af] text-[12px] top-[0.5px] whitespace-nowrap">No additional domain block rules configured.</p>
      </div>
    </div>
  );
}
...
function Text34() {
  return (
    <div className="h-[18px] relative shrink-0 w-[85.664px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Geo-Blocking</p>
      </div>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[36px] not-italic text-[#364153] text-[12px] top-[0.5px] whitespace-nowrap">Block High-Risk Regions:</p>
      </div>
    </div>
  );
}
...
function Ho8() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[36px] px-[9px] py-[4px] rounded-[6px] top-0 w-[54.805px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Russia</p>
    </div>
  );
}
...
function Ho9() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[96.8px] px-[9px] py-[4px] rounded-[6px] top-0 w-[50.461px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">China</p>
    </div>
  );
}
...
function Ho10() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[153.27px] px-[9px] py-[4px] rounded-[6px] top-0 w-[39.43px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Iran</p>
    </div>
  );
}
...
function Ho11() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[198.7px] px-[9px] py-[4px] rounded-[6px] top-0 w-[86.563px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">North Korea</p>
    </div>
  );
}
...
function Ho12() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[291.26px] px-[9px] py-[4px] rounded-[6px] top-0 w-[120.617px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Brazil (Fraud Risk)</p>
    </div>
  );
}
...
function Ho13() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[417.88px] px-[9px] py-[4px] rounded-[6px] top-0 w-[181.844px]" data-name="ho">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Eastern Europe (Cybercrime)</p>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="h-[118px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start pl-[17px] pr-px py-[17px] relative size-full">
        <Container53 />
        <Paragraph7 />
      ...
      <div className="absolute inset-[12.44%_8.34%_12.5%_8.26%]" data-name="Vector">
        <div className="absolute inset-[-5.55%_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6773 13.3427">
            <path d={svgPaths.p19ed2c80} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
...
function Text36() {
  return (
    <div className="h-[18px] relative shrink-0 w-[213.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Risk-Based URL Blocking (AI/NLP)</p>
      </div>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="h-[28px] relative shrink-0 w-[808px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Ca5 />
        <Text36 />
        <Ka3 />
...
function Paragraph8() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[36px] not-italic text-[#6a7282] text-[12px] top-[0.5px] whitespace-nowrap">AI-based classification to prevent phishing and typo-squatting.</p>
      </div>
    </div>
  );
}
...
function Icon27() {
  return (
    <div className="absolute left-[11px] size-[14px] top-[8px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_41024_21222)" id="Icon">
          <path d={svgPaths.pc012c00} id="Vector" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d={svgPaths.p2f231d00} id="Vector_2" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
        <defs>
          <clipPath id="clip0_41024_21222">
...
function Text37() {
  return (
    <div className="absolute h-[18px] left-[31px] top-[6px] w-[34.188px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Block</p>
    </div>
  );
}
...
function Text38() {
  return (
    <div className="absolute border-[#e5e7eb] border-l border-solid h-[15px] left-[73.19px] top-[7.5px] w-[57.391px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[15px] left-[6px] not-italic text-[#6a7282] text-[11px] top-0 whitespace-nowrap">High-Risk</p>
    </div>
  );
}
...
function Container58() {
  return (
    <div className="bg-white h-[30px] relative rounded-[8px] shrink-0 w-[141.578px]" data-name="Container">
...
function Icon28() {
  return (
    <div className="absolute left-[11px] size-[14px] top-[8px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_41024_21196)" id="Icon">
          <path d={svgPaths.pc012c00} id="Vector" stroke="var(--stroke-0, #FE9A00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M7 4.66667V7" id="Vector_2" stroke="var(--stroke-0, #FE9A00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M7 9.33333H7.00583" id="Vector_3" stroke="var(--stroke-0, #FE9A00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
        <defs>
          <clipPath id="clip0_41024_21196">
            <rect fill="white" height="14" width="14" />
          </clipPath>
        </defs>
      </svg>
...
function Text39() {
  return (
    <div className="absolute h-[18px] left-[31px] top-[6px] w-[32.18px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Warn</p>
    </div>
  );
}
...
function Text40() {
  return (
    <div className="absolute border-[#e5e7eb] border-l border-solid h-[15px] left-[71.18px] top-[7.5px] w-[75.016px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[15px] left-[6px] not-italic text-[#6a7282] text-[11px] top-0 whitespace-nowrap">Medium-Risk</p>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="bg-white h-[30px] relative rounded-[8px] shrink-0 w-[157.195px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon28 />
        <Text39 />
...
function Text41() {
  return (
    <div className="absolute h-[18px] left-[31px] top-[6px] w-[33.914px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Allow</p>
    </div>
  );
}
...
function Text42() {
  return (
    <div className="absolute border-[#e5e7eb] border-l border-solid h-[15px] left-[72.91px] top-[7.5px] w-[54.922px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[15px] left-[6px] not-italic text-[#6a7282] text-[11px] top-0 whitespace-nowrap">Low-Risk</p>
    </div>
  );
}
...
function Container60() {
  return (
    <div className="bg-white h-[30px] relative rounded-[8px] shrink-0 w-[138.836px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon29 />
        <Text41 />
...
function Container57() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[808px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] items-start pl-[36px] relative size-full">
        <Container58 />
        <Container59 />
        <Container60 />
      </div>
...
function Paragraph9() {
  return (
    <div className="h-[14px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[14px] left-[36px] not-italic text-[#9ca3af] text-[10px] top-0 whitespace-nowrap">Note: Not supported on Linux/Chromebooks (safe to leave ON).</p>
      </div>
    </div>
  );
}
...
function Text44() {
  return (
    <div className="h-[18px] relative shrink-0 w-[82.211px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#6a7282] text-[13px] top-0 whitespace-nowrap">URL Allowlist</p>
      </div>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[36px] not-italic text-[#6a7282] text-[12px] top-[0.5px] whitespace-nowrap">Add only business-critical domains to ensure inspection never interferes with operations.</p>
      </div>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Italic',sans-serif] font-normal italic leading-[16px] left-[36px] text-[#9ca3af] text-[12px] top-[0.5px] whitespace-nowrap">No URL allowlist rules configured.</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="h-[965px] relative shrink-0 w-full" data-name="Container">
...
function Container40() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px] w-[900px]" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start p-px relative size-full">
          <Container41 />
        </div>
...
function Paragraph12() {
  return (
    <div className="h-[16px] relative shrink-0 w-[900px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-[0.5px] whitespace-nowrap">* Default profile based on small business best practices</p>
      </div>
    </div>
  );
}
...
function Sc4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[37.945px]" data-name="SC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[19px] not-italic text-[#364153] text-[14px] text-center top-[0.5px] whitespace-nowrap">Close</p>
      </div>
    </div>
  );
}
...
function Button7() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[79.945px]" data-name="Button">
...
function Sc5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[69.734px]" data-name="SC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[35px] not-italic text-[14px] text-center text-white top-[0.5px] whitespace-nowrap">Edit Policy</p>
      </div>
    </div>
  );
}
...
function Button8() {
  return (
    <div className="bg-[#d4183d] h-[36px] relative rounded-[8px] shrink-0 w-[115.734px]" data-name="Button">
...
function Sc() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1891px] items-start left-[32px] top-[96px] w-[900px]" data-name="SC">
      <Button3 />
      <Container6 />
      <Container12 />
      <Container40 />
...
function Container() {
  return (
    <div className="flex-[1_0_0] h-[2019px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <T />
        <Sc />
      </div>
...
function Section() {
  return <div className="h-[2019px] shrink-0 w-0" data-name="Section" />;
}

function C() {
  return (
    <div className="bg-[#f9fafb] h-[2019px] relative shrink-0 w-full" data-name="c5">
...
function Body() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[996px] items-start left-0 top-0 w-[1728px]" data-name="Body">
      <C />
    </div>
  );
}
...
function Icon35() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41011_2301)" id="Icon">
...
function Icon36() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41011_2363)" id="Icon">
...
function Icon37() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_41024_21179)" id="Icon">
...
export default function ZtpDesign() {
  return (
    <div className="bg-white relative size-full" data-name="ZTP Design 2.91">
      <Body />
      <O />
      <Component />
    </div>
