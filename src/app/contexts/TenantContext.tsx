  ...
  const getTenantData = (): TenantData => {
    ...
    if (currentTenant.id === 'riverside') {
      ...
      if (isActivated) {
        return {
          policies,
          users: [
            { id: 1,  name: 'Dr. Maria Henderson', email: 'maria@riversidedental.com',    roles: 'admin, auth-role-dental-staff, role-device-ownership', deviceName: 'Maria-MacBook-Pro',  lastLogin: '2/2/2026, 9:15:23 AM',   ucApps: ['THERON', 'CSE'] },
            { id: 2,  name: 'Jessica Torres',       email: 'jessica@riversidedental.com',  roles: 'user, role-device-ownership',                           deviceName: 'Jessica-Desktop',    lastLogin: '2/3/2026, 8:42:11 AM',   ucApps: ['THERON'] },
            { id: 3,  name: 'Mark Stevens',         email: 'mark@riversidedental.com',     roles: 'user, role-device-ownership',                           deviceName: 'Mark-Laptop',        lastLogin: '2/1/2026, 3:22:45 PM',   ucApps: ['CSE'] },
            { id: 4,  name: 'Angela Price',         email: 'angela@riversidedental.com',   roles: 'user, auth-role-dental-staff',                          deviceName: 'Angela-Surface',     lastLogin: '2/3/2026, 7:55:10 AM',   ucApps: ['THERON'] },
            { id: 5,  name: 'Kevin Nguyen',         email: 'kevin@riversidedental.com',    roles: 'user, role-device-ownership',                           deviceName: 'Kevin-Desktop',      lastLogin: '1/28/2026, 5:30:44 PM',  ucApps: [] },
            { id: 6,  name: 'Sandra Lee',           email: 'sandra@riversidedental.com',   roles: 'user, auth-role-dental-staff',                          deviceName: '—',                  lastLogin: '—',                      ucApps: ['CSE'] },
            { id: 7,  name: 'Brian Holloway',       email: 'brian@riversidedental.com',    roles: 'user, role-device-ownership',                           deviceName: 'Brian-Windows-PC',   lastLogin: '1/30/2026, 11:20:05 AM', ucApps: ['THERON'] },
            { id: 8,  name: 'Tanya Okafor',         email: 'tanya@riversidedental.com',    roles: 'user, auth-role-dental-staff',                          deviceName: 'Tanya-MacBook-Air',  lastLogin: '2/2/2026, 4:08:51 PM',   ucApps: ['CSE'] },
            { id: 9,  name: 'Luis Contreras',       email: 'luis@riversidedental.com',     roles: 'user, role-device-ownership',                           deviceName: 'Luis-ThinkPad',      lastLogin: '1/25/2026, 9:44:32 AM',  ucApps: [] },
            { id: 10, name: 'Rachel Pham',          email: 'rachel@riversidedental.com',   roles: 'user, auth-role-dental-staff',                          deviceName: '—',                  lastLogin: '—',                      ucApps: ['THERON', 'CSE'] },
            { id: 11, name: 'Omar Shaikh',          email: 'omar@riversidedental.com',     roles: 'user, role-device-ownership',                           deviceName: 'Omar-Surface-Go',    lastLogin: '2/1/2026, 6:17:44 PM',   ucApps: ['THERON'] },
            { id: 12, name: 'Diane Kessler',        email: 'diane@riversidedental.com',    roles: 'user, auth-role-dental-staff, role-device-ownership',   deviceName: 'Diane-Laptop',       lastLogin: '1/29/2026, 2:55:19 PM',  ucApps: ['CSE'] },
          ],
          dashboardMetrics: {
            totalUsers: 12,
            activeUsers: 9,
    ...
    if (currentTenant.id === 'acme') {
      return {
        policies,
        users: [
          { id: 1, name: 'James Whitfield', email: 'james.whitfield@acmecorp.com', roles: 'Chromebook-ITP, role-device-ownership, auth-r...', deviceName: 'James-MacBook-Pro', lastLogin: '8/12/2025, 4:09:42 PM', ucApps: ['THERON', 'CSE'] },
          { id: 2, name: "Sarah O'Brien", email: 'sarah.obrien@acmecorp.com', roles: 'auth-role-standard, role-device-ownership', deviceName: 'Sarah-Windows-PC', lastLogin: '6/16/2025, 8:03:04 AM', ucApps: ['THERON'] },
          { id: 3, name: 'Lucas Fernandez', email: 'lucas.fernandez@acmecorp.com', roles: 'role-device-ownership, auth-role-august-reset', deviceName: 'Lucas-Laptop', lastLogin: '7/22/2025, 7:14:27 AM', ucApps: ['CSE'] },
          { id: 4, name: 'Emily Carter', email: 'emily.carter@acmecorp.com', roles: 'role-device-ownership, auth-role-august-reset', deviceName: '—', lastLogin: '—', ucApps: [] },
          { id: 5, name: 'Tom Bergmann', email: 'tom.bergmann@acmecorp.com', roles: 'role-device-ownership, auth-role-august-reset', deviceName: 'Tom-Desktop', lastLogin: '—', ucApps: ['THERON'] },
          { id: 6, name: 'Rachel Kim', email: 'rachel.kim@acmecorp.com', roles: 'Chromebook-ITP, role-device-ownership, auth-r...', deviceName: 'Rachel-Surface', lastLogin: '—', ucApps: ['THERON', 'CSE'] },
          { id: 7, name: 'Daniel Müller', email: 'daniel.muller@acmecorp.com', roles: 'auth-role-standard, role-device-ownership', deviceName: 'Daniel-MacBook-Air', lastLogin: '1/14/2025, 12:15:52 AM', ucApps: ['CSE'] },
          { id: 8, name: 'Olivia Thompson', email: 'olivia.thompson@acmecorp.com', roles: 'auth-role-standard, UnAuth-Temp, role-device-o...', deviceName: 'Olivia-Dell-XPS', lastLogin: '10/26/2025, 11:47:31 PM', ucApps: [] },
          { id: 9, name: 'Marcus Webb', email: 'marcus.webb@acmecorp.com', roles: 'auth-role-standard, Chromebook-ITP, role-devic...', deviceName: 'Marcus-Mobile', lastLogin: '12/1/2025, 4:04:06 AM', ucApps: ['THERON'] },
          { id: 10, name: 'Claire Dupont', email: 'claire.dupont@acmecorp.com', roles: 'Chromebook-ITP, role-device-ownership, auth-r...', deviceName: 'Claire-ThinkPad', lastLogin: '7/6/2025, 10:49:23 PM', ucApps: ['CSE'] },
          { id: 11, name: 'Nathan Kowalski', email: 'nathan.kowalski@acmecorp.com', roles: 'Chromebook-ITP, role-device-ownership, auth-r...', deviceName: '—', lastLogin: '—', ucApps: ['THERON', 'CSE'] },
          { id: 12, name: 'Priya Venkatesh', email: 'priya.venkatesh@acmecorp.com', roles: 'auth-role-standard, role-device-ownership', deviceName: 'Priya-MacBook-Pro', lastLogin: '5/9/2025, 2:33:17 PM', ucApps: ['CSE'] },
        ],
        dashboardMetrics: {
          totalUsers: 248,
          activeUsers: 186,
