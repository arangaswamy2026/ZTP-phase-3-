import svgPaths from "./svg-bawf48cb7t";
...
function Button1() {
  return (
    <div className="absolute bg-[#1447e6] content-stretch flex h-[24px] items-center left-[1074px] pl-[23px] rounded-[33554400px] top-[16px] w-[44px]" data-name="Button">
      <Text1 />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col h-[128px] items-start pl-[16px] pt-[6px] relative shrink-0 w-[1134px]" data-name="Container">
...
export default function AutoUpdateExpandedOn() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start p-px relative rounded-[8px] size-full" data-name="Auto Update expanded ON">
