import svgPaths from "./svg-g90p6kobap";
...
function Text2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[49.383px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-white top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Policies</p>
      </div>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_47034_1140)" id="Icon">
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_47034_1130)" id="Icon">
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_47034_1090)" id="Icon">
...
function F() {
  return (
    <div className="absolute bg-[#f8f9fa] content-stretch flex flex-col h-[1617px] items-start left-[60.08px] pr-px top-0 w-[192px]" data-name="F4">
...
function CursorPointer() {
  return (
    <div className="absolute left-[1622.08px] size-[72px] top-[309.5px]" data-name="Cursor/Pointer">
...
function Heading() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[335.047px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[20px] top-0 tracking-[-0.8992px] whitespace-nowrap">Policies</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-[335.047px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#6a7282] text-[16px] top-[-0.5px] tracking-[-0.6225px] whitespace-nowrap">Manage and review all your access policies across Internet, Private, and Zone-based traffic.</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[56px] relative shrink-0 w-[335.047px]" data-name="Container">
...
function Container2() {
  return (
    <div className="h-[88px] relative shrink-0 w-[1412px]" data-name="Container">
...
function Container4() {
  return (
    <div className="h-[36px] relative shrink-0 w-[1412px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container5 />
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_47034_1116)" id="Icon">
          <path d={svgPaths.p1a3b4700} id="Vector" stroke="var(--stroke-0, #CA3500)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3c552480} id="Vector_2" stroke="var(--stroke-0, #CA3500)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p174f7d00} id="Vector_3" stroke="var(--stroke-0, #CA3500)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p310deb70} id="Vector_4" stroke="var(--stroke-0, #CA3500)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M10 10V6.66667" id="Vector_5" stroke="var(--stroke-0, #CA3500)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
          <clipPath id="clip0_47034_1116">
...
function Q() {
  return (
    <div className="bg-[#ffedd4] relative rounded-[11px] shrink-0 size-[40px]" data-name="Q8">
...
function Text7() {
  return (
    <div className="h-[28px] relative shrink-0 w-[666.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] tracking-[-0.44px] whitespace-nowrap">Zone Policies</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="h-[24px] relative shrink-0 w-[666.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#6a7282] text-[14px] top-[0.5px] tracking-[-0.31px] whitespace-nowrap">Controls traffic between network zones on the Zero Trust Connector.</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="flex-[1_0_0] h-[55px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pb-[3px] relative size-full">
        <Text7 />
        <Text8 />
      </div>
    </div>
...
function Container8() {
  return (
    <div className="h-[55px] relative shrink-0 w-[714.844px]" data-name="Container">
...
function AC1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[72.555px]" data-name="aC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[36.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-[0.5px] tracking-[-0.15px] whitespace-nowrap">New Policy</p>
      </div>
    </div>
  );
}
...
function Button7() {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[118.555px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center justify-center px-[11px] py-px relative size-full">
        <Icon9 />
        <AC1 />
      </div>
    </div>
...
function Container7() {
  return (
    <div className="h-[55px] relative shrink-0 w-[1412px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between relative size-full">
        <Container8 />
        <Button7 />
      </div>
...
function Paragraph1() {
  return (
    <div className="h-[16px] relative shrink-0 w-[331px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Policy Name</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[16px] relative shrink-0 w-[299px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Source</p>
    </div>
  );
}

function Paragraph3() {
  return <div className="absolute h-[16px] left-[996px] top-[11.75px] w-[115px]" data-name="Paragraph" />;
}
...
function Container11() {
  return (
    <div className="bg-[#f9fafb] h-[33px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[36px] py-[12px] relative size-full">
          <Paragraph1 />
          <Paragraph2 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] tracking-[0.6px] uppercase w-[573px]">Destination</p>
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] tracking-[0.6px] uppercase whitespace-nowrap">Action</p>
          <Paragraph3 />
        </div>
      </div>
    </div>
...
function Container12() {
  return (
    <div className="absolute content-stretch flex flex-col h-[20px] items-start left-0 pl-[8px] pr-[12px] top-[39px] w-[40px]" data-name="Container">
      <Icon10 />
    </div>
  );
}
...
function Paragraph4() {
  return <div className="absolute h-[20px] left-[48px] top-[39px] w-[44px]" data-name="Paragraph" />;
}

function Paragraph5() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-0.5px] tracking-[-0.6225px] w-[231px]">Enable IoT devices to access the internet.</p>
      </div>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[16px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px whitespace-nowrap">Allow devices on iot network access to internet</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[66px] items-start left-[36px] top-[16px] w-[291px]" data-name="Container">
      <Paragraph5 />
      <Paragraph6 />
    </div>
  );
...
function Container14() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[8px] pr-[4px] py-[4px] relative rounded-bl-[10px] rounded-tl-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-bl-[10px] rounded-tl-[10px]" />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[16px]">Zone:</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">IOT</p>
      </div>
    </div>
  );
}
...
function Paragraph7() {
  return <div className="absolute h-[20px] left-[669px] top-[29px] w-[168px]" data-name="Paragraph" />;
}
...
function Container17() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Internet</p>
      </div>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[3px] w-[30.305px]" data-name="Paragraph">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] left-0 not-italic text-[#008236] text-[12px] top-[9px] whitespace-nowrap">
        <p className="leading-[16px]">Allow</p>
      </div>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute bg-[#f0fdf4] border border-[#b9f8cf] border-solid h-[24px] left-[1236px] rounded-[10px] top-[37.75px] w-[48.305px]" data-name="Container">
      <Paragraph8 />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute inset-[8.35%_8.35%_12.5%_12.5%]" data-name="Group">
      <div className="absolute inset-[-5.26%_-5.26%_-5.27%_-5.26%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9975 13.9975">
          <g id="Group">
            <path d={svgPaths.p3ff87300} id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p3781b600} id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </g>
        </svg>
      </div>
    </div>
...
function BoxiconsEye() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="boxicons:eye">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="boxicons:eye">
          <path d={svgPaths.p12fc0b00} fill="var(--fill-0, black)" id="Vector" />
          <path d={svgPaths.p2d459900} fill="var(--fill-0, black)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Container19() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[32px] items-center justify-end left-[1313px] top-[33px]" data-name="Container">
      <Button8 />
      <Button9 />
    </div>
  );
...
function N() {
  return (
    <div className="h-[100px] relative shrink-0 w-full" data-name="n9">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-b border-solid inset-0 pointer-events-none" />
      <Container12 />
      <Paragraph4 />
      <Container13 />
      <div className="absolute content-stretch flex items-center left-[366px] top-[15.5px]" data-name="Pill">
        <Container14 />
        <Container15 />
      </div>
      <Paragraph7 />
      <div className="absolute content-stretch flex items-center left-[669px] top-[16px]" data-name="Pill">
        <Container16 />
        <Container17 />
      </div>
      <Container18 />
...
function Container20() {
  return (
    <div className="absolute content-stretch flex flex-col h-[20px] items-start left-0 pl-[8px] pr-[12px] top-[40px] w-[40px]" data-name="Container">
      <Icon12 />
    </div>
  );
}
...
function Paragraph9() {
  return <div className="absolute h-[20px] left-[48px] top-[40px] w-[44px]" data-name="Paragraph" />;
}
...
function Paragraph10() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-0.5px] tracking-[-0.6225px] w-[269px]">Enable guest network users to access the internet.</p>
      </div>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[16px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px whitespace-nowrap">Allow users on guest network access to internet</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[66px] items-start left-[36px] top-[17px] w-[291px]" data-name="Container">
      <Paragraph10 />
      <Paragraph11 />
    </div>
  );
...
function Container23() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Guest</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="absolute bg-[#f0fdf4] border border-[#b9f8cf] border-solid h-[24px] left-[1236px] rounded-[10px] top-[38.75px] w-[48.305px]" data-name="Container">
      <Paragraph12 />
    </div>
  );
}
...
function Container27() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[32px] items-center justify-end left-[1313px] top-[34px]" data-name="Container">
      <Button10 />
      <Button11 />
    </div>
  );
...
function N1() {
  return (
    <div className="h-[100px] relative shrink-0 w-full" data-name="n9">
      ...
      <Paragraph9 />
      <Container21 />
      <div className="absolute content-stretch flex items-center left-[366px] top-[19px]" data-name="Pill">
        <Container22 />
        <Container23 />
      </div>
      <div className="absolute content-stretch flex items-center left-[669px] top-[17px]" data-name="Pill">
        <Container24 />
        <Container25 />
      </div>
      <Container26 />
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col h-[20px] items-start left-0 pl-[8px] pr-[12px] top-[47px] w-[40px]" data-name="Container">
      <Icon14 />
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="h-[24px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[24px] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 tracking-[-0.6225px] w-[265px]">Permit IoT Network to Storage Server Access</p>
      </div>
    </div>
  );
}
...
function Paragraph14() {
  return (
    <div className="h-[32px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px w-[265px]">Allow devices on iot network access to storage server 10.202.0.24 and port 5123 on employee network</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[82px] items-start left-[36px] top-[16px] w-[291px]" data-name="Container">
      <Paragraph13 />
      <Paragraph14 />
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute bg-[#f0fdf4] border border-[#b9f8cf] border-solid h-[24px] left-[1239px] rounded-[10px] top-[18px] w-[48.305px]" data-name="Container">
      <Paragraph15 />
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[32px] items-center justify-end left-[1322px] top-[41px]" data-name="Container">
      <Button12 />
      <Button13 />
    </div>
  );
...
function Container34() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[8px] pr-[4px] py-[4px] relative rounded-bl-[10px] rounded-tl-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-bl-[10px] rounded-tl-[10px]" />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[16px]">IP Range:</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">10.2.2.83746.273</p>
      </div>
    </div>
  );
}
...
function N2() {
  return (
    <div className="h-[100px] relative shrink-0 w-[1410px]" data-name="n9">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-b border-solid inset-0 pointer-events-none" />
      <Container28 />
      <Container29 />
      <div className="absolute content-stretch flex items-center left-[366px] top-[17.5px]" data-name="Pill">
        <Container30 />
        <Container31 />
      </div>
      <Container32 />
      <Container33 />
      <div className="absolute content-stretch flex items-center left-[672px] top-[18px]" data-name="Pill">
        <Container34 />
        <Container35 />
      </div>
    </div>
...
function Paragraph16() {
  return (
    <div className="h-[24px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[24px] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 tracking-[-0.6225px] w-[265px]">Allow Employee to Guest Zone</p>
      </div>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="h-[32px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px w-[265px]">Allow users on Employee network access to guest zone</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Employees</p>
      </div>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="absolute bg-[#f0fdf4] border border-[#b9f8cf] border-solid h-[24px] left-[1239px] rounded-[10px] top-[21.5px] w-[48.305px]" data-name="Container">
      <Paragraph18 />
    </div>
  );
}
...
function Paragraph19() {
  return (
    <div className="h-[24px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[24px] leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-0 tracking-[-0.6225px] w-[265px]">Block Guest to Employee Zone</p>
      </div>
    </div>
  );
}
...
function Paragraph20() {
  return (
    <div className="h-[32px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px w-[265px]">Block users on guest network access to employee zone</p>
      </div>
    </div>
  );
}
...
function Paragraph21() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[3px] w-[30.305px]" data-name="Paragraph">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] left-0 not-italic text-[#d4183d] text-[12px] top-[9px] whitespace-nowrap">
        <p className="leading-[16px]">Block</p>
      </div>
    </div>
  );
}
...
function Container48() {
  return (
    <div className="absolute bg-[#ffeaeb] border border-[#ff868b] border-solid h-[24px] left-[1239px] rounded-[10px] top-[16px] w-[48.305px]" data-name="Container">
      <Paragraph21 />
    </div>
  );
}
...
function Container10() {
  return (
    <div className="bg-white relative rounded-[10px] shrink-0 w-[1412px]" data-name="Container">
      ...
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" />
    </div>
  );
}
...
function AC() {
  return (
    <div className="relative shrink-0 w-[1412px]" data-name="aC">
...
function Icon20() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_47034_1149)" id="Icon">
          <path d={svgPaths.p14d24500} id="Vector" stroke="var(--stroke-0, #8200DB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p17212180} id="Vector_2" stroke="var(--stroke-0, #8200DB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M1.66667 10H18.3333" id="Vector_3" stroke="var(--stroke-0, #8200DB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
          <clipPath id="clip0_47034_1149">
            <rect fill="white" height="20" width="20" />
          </clipPath>
        </defs>
      </svg>
...
function SiaIcon() {
  return (
    <div className="bg-[#f3e8ff] relative rounded-[11px] shrink-0 size-[40px]" data-name="SIAIcon">
...
function Text9() {
  return (
    <div className="h-[21px] relative shrink-0 w-[639.391px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] tracking-[-0.44px] whitespace-nowrap">Internet Access Policies</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="h-[24px] relative shrink-0 w-[639.391px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#6a7282] text-[14px] top-0 tracking-[-0.31px] whitespace-nowrap">Controls user traffic destined for the public internet, including category filtering and threat protection.</p>
      </div>
    </div>
  );
}
...
function Container53() {
  return (
    <div className="h-[55px] relative shrink-0 w-[687.391px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <SiaIcon />
        <Container54 />
      </div>
...
function Container52() {
  return (
    <div className="content-stretch flex h-[55px] items-center justify-between relative shrink-0 w-[1412px]" data-name="Container">
      <Container53 />
      <Button18 />
    </div>
  );
...
function Paragraph22() {
  return (
    <div className="h-[16px] relative shrink-0 w-[225px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Policy Name</p>
    </div>
  );
}
...
function Paragraph23() {
  return (
    <div className="h-[16px] relative shrink-0 w-[210px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Source</p>
    </div>
  );
}
...
function Paragraph24() {
  return (
    <div className="h-[16px] relative shrink-0 w-[168px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Destination</p>
    </div>
  );
}
...
function Paragraph25() {
  return (
    <div className="h-[16px] relative shrink-0 w-[168px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">SeCURITY CONTROLS</p>
    </div>
  );
}
...
function Paragraph26() {
  return (
    <div className="h-[16px] relative shrink-0 w-[115px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Action</p>
    </div>
  );
}

function Paragraph27() {
  return <div className="absolute h-[16px] left-[48px] top-[11.75px] w-[44px]" data-name="Paragraph" />;
}

function Paragraph28() {
  return <div className="absolute h-[16px] left-[439px] top-[11.75px] w-[85px]" data-name="Paragraph" />;
}
...
function Container56() {
  return (
    <div className="bg-[#f9fafb] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[106px] items-center px-[36px] py-[12px] relative w-full">
          <Paragraph22 />
          <Paragraph23 />
          <Paragraph24 />
          <Paragraph25 />
...
function Paragraph30() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-0.5px] tracking-[-0.6225px] whitespace-nowrap">Allow Engineering internet; block Netflix.</p>
      </div>
    </div>
  );
}
...
function Paragraph31() {
  return (
    <div className="h-[16px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px whitespace-nowrap">Allow Engineering internet; block Netflix.</p>
      </div>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[42px] items-start left-[36px] top-[29px] w-[291px]" data-name="Container">
      <Paragraph30 />
      <Paragraph31 />
    </div>
  );
...
function Container60() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[8px] pr-[4px] py-[4px] relative rounded-bl-[10px] rounded-tl-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-bl-[10px] rounded-tl-[10px]" />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[16px]">Group:</p>
      </div>
    </div>
  );
}
...
function Container61() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Engineering</p>
      </div>
    </div>
  );
}
...
function Container62() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center px-[8px] py-[4px] relative rounded-[10px] shrink-0" data-name="Container">
...
function N5() {
  return (
    <div className="h-[100px] relative shrink-0 w-full" data-name="n9">
      ...
      <Paragraph29 />
      <Container59 />
      <div className="absolute content-stretch flex items-center left-[365px] top-[32.5px]" data-name="Pill">
        <Container60 />
        <Container61 />
      </div>
      <div className="absolute content-stretch flex items-center left-[682px] top-[30px]" data-name="Pill">
        <Container62 />
      </div>
      <div className="absolute content-stretch flex items-center left-[968px] top-[31.75px]" data-name="Pill">
        <Container63 />
      </div>
      <Container64 />
      <Container65 />
...
function Paragraph34() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-0.5px] tracking-[-0.6225px] whitespace-nowrap">Enable internet access for user Alice.</p>
      </div>
    </div>
  );
}
...
function Paragraph35() {
  return (
    <div className="h-[16px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px whitespace-nowrap">Allow internet access to user Alice</p>
      </div>
    </div>
  );
}
...
function Container69() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center p-[4px] relative shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">John</p>
      </div>
    </div>
  );
}
...
function Paragraph36() {
  return (
    <div className="absolute h-[25px] left-[682px] overflow-clip top-[30px] w-[105px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#364153] text-[14px] top-[0.5px] tracking-[-0.3004px] whitespace-nowrap">{`Internet `}</p>
      <div className="absolute content-stretch flex items-center left-0 top-px" data-name="Pill">
        <Container72 />
      </div>
    </div>
  );
...
function N6() {
  return (
    <div className="h-[100px] relative shrink-0 w-full" data-name="n9">
      ...
      <Paragraph33 />
      <Container67 />
      <div className="absolute content-stretch flex items-center left-[366px] top-[32.5px]" data-name="Pill">
        <Container68 />
        <Container69 />
        <Container70 />
        <Container71 />
      ...
      <Paragraph36 />
      <div className="absolute content-stretch flex items-center left-[968px] top-[31.25px]" data-name="Pill">
        <Container73 />
      </div>
      <Container74 />
      <Container75 />
...
function Paragraph39() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-0.5px] tracking-[-0.6225px] whitespace-nowrap">Allow All Users to Internet</p>
      </div>
    </div>
  );
}
...
function Paragraph40() {
  return (
    <div className="h-[16px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px whitespace-nowrap">Allow internet access to all users</p>
      </div>
    </div>
  );
}
...
function Container79() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">All Users</p>
      </div>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[9px] items-start relative">
        <Container52 />
        <Container55 />
      </div>
    </div>
...
function Icon28() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p2566d000} id="Vector" stroke="var(--stroke-0, #1447E6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1bf79e00} id="Vector_2" stroke="var(--stroke-0, #1447E6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function SpaIcon() {
  return (
    <div className="bg-[#dbeafe] relative rounded-[11px] shrink-0 size-[40px]" data-name="SPAIcon">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon28 />
      </div>
    </div>
...
function Text11() {
  return (
    <div className="h-[21px] relative shrink-0 w-[547.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[16px] top-[-1px] tracking-[-0.44px] whitespace-nowrap">Private Access Policies</p>
      </div>
    </div>
  );
}
...
function Text12() {
  return (
    <div className="h-[24px] relative shrink-0 w-[546.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#6a7282] text-[14px] top-0 tracking-[-0.31px] whitespace-nowrap">Controls user access to internal applications and resources using Zero Trust principles.</p>
      </div>
    </div>
  );
}
...
function Container85() {
  return (
    <div className="h-[55px] relative shrink-0 w-[594.406px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <SpaIcon />
        <Container86 />
      </div>
...
function Container84() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1412px]" data-name="Container">
      <Container85 />
      <Button25 />
    </div>
  );
...
function Paragraph43() {
  return (
    <div className="h-[16px] relative shrink-0 w-[333px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Policy Name</p>
    </div>
  );
}
...
function Paragraph44() {
  return (
    <div className="h-[16px] relative shrink-0 w-[297px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px tracking-[0.6px] uppercase whitespace-nowrap">Source</p>
    </div>
  );
}
...
function Container88() {
  return (
    <div className="bg-[#f9fafb] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[36px] py-[12px] relative w-full">
          <Paragraph43 />
          <Paragraph44 />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] tracking-[0.6px] uppercase w-[305px]">Destination</p>
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] tracking-[0.6px] uppercase w-[267px]">TrusT LEVEL</p>
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] tracking-[0.6px] uppercase whitespace-nowrap">Action</p>
          <Paragraph45 />
        </div>
      </div>
...
function Container90() {
  return (
    <div className="absolute content-stretch flex flex-col h-[20px] items-start left-0 pl-[8px] pr-[12px] top-[35px] w-[40px]" data-name="Container">
      <Icon30 />
    </div>
  );
}
...
function Paragraph46() {
  return (
    <div className="h-[24px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-0.5px] tracking-[-0.6225px] whitespace-nowrap">Allow Alice and John to Host IP 10.0.0.2</p>
      </div>
    </div>
  );
}
...
function Paragraph47() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px w-[278px]">Allow user alice and john access from office to host ip 10.0.0.2 on port 22 on the same network</p>
      </div>
    </div>
  );
}
...
function Container91() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] h-[58px] items-start left-[36px] top-[16px] w-[291px]" data-name="Container">
      <Paragraph46 />
      <Paragraph47 />
    </div>
  );
...
function Container93() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Alice, John</p>
      </div>
    </div>
  );
}
...
function Container94() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[8px] pr-[4px] py-[4px] relative rounded-bl-[10px] rounded-tl-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-bl-[10px] rounded-tl-[10px]" />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[16px]">FQDN:</p>
      </div>
    </div>
  );
}
...
function Container95() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[8px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-br-[10px] rounded-tr-[10px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">10.0.2.2</p>
      </div>
    </div>
  );
}
...
function Container96() {
  return (
    <div className="absolute bg-[#f0fdf4] border border-[#b9f8cf] border-solid h-[24px] left-[1239px] rounded-[10px] top-[33.75px] w-[48.305px]" data-name="Container">
      <Paragraph48 />
    </div>
  );
}
...
function Container97() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[32px] items-center justify-end left-[1322px] top-[29px]" data-name="Container">
      <Button26 />
      <Button27 />
    </div>
  );
...
function N8() {
  return (
    <div className="h-[91px] relative shrink-0 w-full" data-name="n9">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-b border-solid inset-0 pointer-events-none" />
      <Container90 />
      <Container91 />
      <div className="absolute content-stretch flex items-center left-[366px] top-[35px]" data-name="Pill">
        <Container92 />
        <Container93 />
      </div>
      <div className="absolute content-stretch flex items-center left-[666.08px] top-[34px]" data-name="Pill">
        <Container94 />
        <Container95 />
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[18px] leading-[20px] left-[968px] not-italic text-[#364153] text-[14px] top-[37px] tracking-[-0.3004px] w-[63px]">High trust</p>
      <Container96 />
      <Container97 />
    </div>
  );
...
function Container98() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[9px] py-[4px] relative rounded-bl-[10px] rounded-tl-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-l border-solid border-t inset-0 pointer-events-none rounded-bl-[10px] rounded-tl-[10px]" />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">Zone:</p>
    </div>
  );
}
...
function Container99() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative shrink-0 w-[97px]" data-name="Container">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">Employees</p>
    </div>
  );
}
...
function Container100() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[9px] py-[4px] relative rounded-bl-[10px] rounded-tl-[10px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-l border-solid border-t inset-0 pointer-events-none rounded-bl-[10px] rounded-tl-[10px]" />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">Group:</p>
    </div>
  );
}
...
function Container101() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative shrink-0" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">{` Engineers`}</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11px] items-start left-[366px] top-[16.5px] w-[126px]">
      <Frame3 />
...
function Container103() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative shrink-0 w-[43px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-l border-solid border-t inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">HR</p>
    </div>
  );
}
...
function Container105() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative shrink-0" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">10.202.2.24:5123</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11px] items-start left-[666px] top-[15.5px] w-[126px]">
      <Frame4 />
      <div className="relative rounded-[8px] shrink-0">
        <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit]">
          <Container104 />
...
function Paragraph49() {
  return (
    <div className="h-[24px] relative shrink-0 w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-0.5px] tracking-[-0.6225px] whitespace-nowrap">Permit Engineering Group to HR Subnet</p>
      </div>
    </div>
  );
}
...
function Paragraph50() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[291px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-px w-[278px]">Allow access to subnet 10.202.0.0/24 on hr network segment to user group Engineering from employee network</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute inset-[16.67%_45.83%]" data-name="Group">
      <div className="absolute inset-[-6.25%_-50%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.66667 12">
          <g id="Group">
            <path d={svgPaths.p181e0300} id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p3c8042f0} id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p1261fd00} id="Vector_3" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </g>
        </svg>
      </div>
    </div>
...
function Container87() {
  return (
    <div className="bg-white h-[133px] relative rounded-[10px] shrink-0 w-[1412px]" data-name="Container">
...
function R1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-[32px] top-[96px] w-[1412px]" data-name="r9">
      <Container2 />
      <Container4 />
      <AC />
      <Frame1 />
...
function Container110() {
  return (
    <div className="h-[20px] relative shrink-0 w-[219px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text14 />
        <Text15 />
        <Text16 />
...
function T() {
  return (
    <div className="bg-white h-[64px] relative shrink-0 w-full" data-name="T6">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-px px-[24px] relative size-full">
          <div className="absolute h-[37px] left-[457.08px] top-[13px] w-[500px]" data-name="Component 5">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
              <Button30 />
            </div>
          </div>
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex flex-col h-[64px] items-start left-[0.08px] top-0 w-[1476px]">
      <T />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="flex-[1_0_0] h-[1388px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <R1 />
        <Frame7 />
      </div>
...
function U() {
  return (
    <div className="bg-[#f9fafb] h-[1390px] relative shrink-0 w-full" data-name="u5">
...
function Body() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[1523px] items-start left-[0.08px] top-0 w-[1728px]" data-name="Body">
      <U />
    </div>
  );
}
...
function Union4() {
  return (
    <div className="absolute inset-[0_1.72%_0.4%_0]" data-name="Union">
...
function Component() {
  return (
    <div className="absolute bg-[#001b50] content-stretch flex flex-col h-[1622px] items-center left-[0.08px] top-0 w-[60px]" data-name="_6">
      <R />
      <Container114 />
    </div>
  );
...
export default function Policies3TableView() {
  return (
    <div className="bg-white relative size-full" data-name="Policies (3 Table view)">
      <F />
      <CursorPointer />
      <Body />
      <Component />
