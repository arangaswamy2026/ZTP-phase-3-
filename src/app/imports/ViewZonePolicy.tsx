import svgPaths from "./svg-sphm6hxe87";
...
function Text1() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative rounded-[16777200px]" data-name="Text">
...
function Container4() {
  return (
    <div className="h-[24px] relative shrink-0 w-[222.18px]" data-name="Container">
...
function BC1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[68.086px]" data-name="bC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_45045_1759)" id="Icon">
...
function BC2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[61.961px]" data-name="bC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function BC3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[42.492px]" data-name="bC">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Heading() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[842px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[22px] top-[0.5px] tracking-[-0.5px] whitespace-nowrap">Allow Employee Zone to Internet</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-[842px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[0.5px] whitespace-nowrap">Allow outbound traffic from Employee Zone</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="bg-[#f9fafb] h-[80px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start pl-[21px] pr-px py-[17px] relative size-full">
        <Text4 />
        <Paragraph1 />
      </div>
    </div>
...
function Container1() {
  return (
    <div className="bg-white h-[250px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
...
function Gn() {
  return (
    <div className="bg-[#f3f4f6] relative rounded-[6px] shrink-0 size-[28px]" data-name="Gn">
...
function Kn() {
  return (
    <div className="bg-[#dbeafe] h-[19px] relative rounded-[6px] shrink-0 w-[44.148px]" data-name="Kn">
...
function Wa() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[36px] px-[9px] py-[4px] rounded-[6px] top-0 w-[87.07px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Adult Issues</p>
    </div>
  );
}
...
function Wa1() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[129.07px] px-[9px] py-[4px] rounded-[6px] top-0 w-[71.594px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">Gambling</p>
    </div>
  );
}
...
function Wa2() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[206.66px] px-[9px] py-[4px] rounded-[6px] top-0 w-[165.039px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Wa3() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[36px] px-[9px] py-[4px] rounded-[6px] top-0 w-[73.625px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">BitTorrent</p>
    </div>
  );
}
...
function Wa4() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[115.63px] px-[9px] py-[4px] rounded-[6px] top-0 w-[70.672px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">NordVPN</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="h-[86px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start pl-[17px] pr-px py-[17px] relative size-full">
        <Container32 />
        <Paragraph3 />
...
function Wa5() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[36px] px-[9px] py-[4px] rounded-[6px] top-0 w-[140.609px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">malware-domain.com</p>
    </div>
  );
}
...
function Wa6() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[182.61px] px-[9px] py-[4px] rounded-[6px] top-0 w-[114.688px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px] whitespace-nowrap">phishing-site.xyz</p>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="h-[18px] relative shrink-0 w-[96.906px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#6a7282] text-[13px] top-0 whitespace-nowrap">Domain Bypass</p>
      </div>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[16px] relative shrink-0 w-[808px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Italic',sans-serif] font-normal italic leading-[16px] left-[36px] text-[#9ca3af] text-[12px] top-[0.5px] whitespace-nowrap">No domain bypass rules configured.</p>
      </div>
    </div>
  );
}
...
function Wa7() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[36px] px-[9px] py-[4px] rounded-[6px] top-0 w-[54.805px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Wa8() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[96.8px] px-[9px] py-[4px] rounded-[6px] top-0 w-[50.461px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Wa9() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[153.27px] px-[9px] py-[4px] rounded-[6px] top-0 w-[39.43px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Wa10() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[24px] items-center left-[198.7px] px-[9px] py-[4px] rounded-[6px] top-0 w-[86.563px]" data-name="wa">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Paragraph6() {
  return (
    <div className="h-[16px] relative shrink-0 w-[842px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#9ca3af] text-[12px] top-[0.5px] whitespace-nowrap">Risk Based URL Blocking is not supported on Linux and Chromebooks.</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="h-[44px] relative shrink-0 w-[842px]" data-name="Container">
  ...
  return (
    <div className="absolute left-[11px] size-[14px] top-[8px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_45045_1797)" id="Icon">
...
function Icon12() {
  return (
    <div className="absolute left-[11px] size-[14px] top-[8px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_45045_1752)" id="Icon">
...
function Icon13() {
  return (
    <div className="absolute left-[11px] size-[14px] top-[8px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_45045_1782)" id="Icon">
...
function Container42() {
  return (
    <div className="h-[122px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start pl-[17px] pr-px py-[17px] relative size-full">
        <Container43 />
        <Paragraph7 />
...
function Text28() {
  return (
    <div className="h-[18px] relative shrink-0 w-[113px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">Flood Protection</p>
      </div>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="h-[59px] relative rounded-[10px] shrink-0 w-[842px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[17px] pr-px py-[17px] relative size-full">
        <Container51 />
      </div>
    </div>
  );
...
function Text30() {
  return (
    <div className="h-[18px] relative shrink-0 w-[30px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">IPS</p>
      </div>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="h-[1172px] relative shrink-0 w-full" data-name="Container">
...
function Container23() {
  return (
    <div className="bg-white h-[1173px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container24 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function BC() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1796px] items-center left-[-24px] top-0 w-[1468px]" data-name="bC">
      <Button />
      <Container1 />
      <Container8 />
      <Container23 />
...
function Frame() {
  return (
    <div className="absolute h-[1846px] left-[32px] overflow-x-clip overflow-y-auto top-[96px] w-[1444px]">
      <BC />
    </div>
  );
}
...
function Icon20() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_45045_1709)" id="Icon">
...
function Container() {
  return (
    <div className="flex-[1_0_0] h-[1942px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Frame />
        <T />
      </div>
...
function Section() {
  return <div className="h-[2031px] shrink-0 w-0" data-name="Section" />;
}

function C() {
  return (
    <div className="bg-[#f9fafb] h-[1942px] relative shrink-0 w-full" data-name="c5">
...
function Body() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[1942px] items-start left-0 top-0 w-[1728px]" data-name="Body">
      <C />
    </div>
  );
}
...
function Icon25() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_45045_1801)" id="Icon">
...
function Icon26() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_45045_1686)" id="Icon">
...
function Icon27() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_45045_1681)" id="Icon">
...
function Union3() {
  return (
    <div className="absolute inset-[0_0.71%_1.46%_0]" data-name="Union">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.5242 28.154">
        <g id="Union">
...
export default function ViewZonePolicy() {
  return (
    <div className="bg-white relative size-full" data-name="View zone policy">
      <Body />
      <O />
      <Component />
    </div>
