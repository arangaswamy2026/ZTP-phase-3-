import svgPaths from "./svg-98myy72dxj";
...
function Text2() {
  return (
    <div className="bg-[#16a34a] h-[22px] relative rounded-[33554400px] shrink-0 w-[60.188px]" data-name="Text">
...
function Text3() {
  return (
    <div className="bg-[#f3f4f6] h-[21px] relative rounded-[6px] shrink-0 w-[53.297px]" data-name="Text">
...
function Container4() {
  return (
    <div className="h-[24px] relative shrink-0 w-[233.219px]" data-name="Container">
...
function PrivateAccessPolicyDetailPage1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[68.094px]" data-name="PrivateAccessPolicyDetailPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[34.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-0 tracking-[-0.15px] whitespace-nowrap">Edit Policy</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[8px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center justify-center p-px relative size-full">
        <Icon1 />
        <PrivateAccessPolicyDetailPage1 />
      </div>
    </div>
  );
}
...
function PrivateAccessPolicyDetailPage2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[61.969px]" data-name="PrivateAccessPolicyDetailPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[31.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-0 tracking-[-0.15px] whitespace-nowrap">Duplicate</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[105.969px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center justify-center p-px relative size-full">
        <Icon2 />
        <PrivateAccessPolicyDetailPage2 />
      </div>
    </div>
  );
}
...
function PrivateAccessPolicyDetailPage3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[42.484px]" data-name="PrivateAccessPolicyDetailPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[21.5px] not-italic text-[#e7000b] text-[14px] text-center top-0 tracking-[-0.15px] whitespace-nowrap">Delete</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[86.484px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#ffc9c9] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center justify-center p-px relative size-full">
        <Icon3 />
        <PrivateAccessPolicyDetailPage3 />
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="h-[32px] relative shrink-0 w-[320.547px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Button1 />
        <Button2 />
        <Button3 />
...
function Heading() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[842px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[22px] top-px tracking-[-0.5px] whitespace-nowrap">Allow Alice and John to Host IP 10.0.0.2</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-[842px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-0 whitespace-nowrap">Base access policy for verified corporate devices</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[9px] py-[4px] relative shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-l border-solid border-t inset-0 pointer-events-none" />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">FQDN:</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">10.0.2.2</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col h-[24px] items-start relative shrink-0 w-full">
      <div className="relative rounded-[8px] shrink-0 w-[107px]">
        <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit] w-full">
          <Container14 />
          <Container15 />
        </div>
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p37f49070} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Heading2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[92.656px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#101828] text-[15px] whitespace-nowrap">Device Trust</p>
      </div>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="h-[20px] relative shrink-0 w-[842px]" data-name="Container">
...
function Paragraph2() {
  return (
    <div className="h-[18px] relative shrink-0 w-[842px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#6a7282] text-[13px] top-0 whitespace-nowrap">Minimum trust level required for device access.</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[18px] relative shrink-0 w-[97.469px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101828] text-[13px] top-0 whitespace-nowrap">High Trust Only</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="bg-[#dcfce7] h-[20.5px] relative rounded-[6px] shrink-0 w-[37.438px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[8px] py-[2px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] not-italic relative shrink-0 text-[#16a34a] text-[11px] whitespace-nowrap">Live</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_45048_4329)" id="Icon">
          <path d={svgPaths.pc012c00} id="Vector" stroke="var(--stroke-0, #16A34A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.45833" />
          <path d={svgPaths.p24f94f00} id="Vector_2" stroke="var(--stroke-0, #16A34A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.45833" />
        </g>
        <defs>
          <clipPath id="clip0_45048_4329">
    ...
    <div className="h-[18px] relative shrink-0 w-[202.516px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-0 not-italic text-[#6a7282] text-[0px] top-0 whitespace-nowrap">
          ...
          <span className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] text-[#101828] text-[12px]">{`Deny & Low latent`}</span>
        </p>
      </div>
    </div>
  );
...
function Container21() {
  return (
    <div className="h-[18px] relative shrink-0 w-[808px]" data-name="Container">
...
function Container19() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] min-h-px min-w-px relative rounded-[10px] w-[842px]" data-name="Container">
...
function Container16() {
  return (
    <div className="bg-white h-[184.5px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container17 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Heading3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[146.719px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#101828] text-[15px] whitespace-nowrap">Default Trust Profile</p>
      </div>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="h-[42.5px] relative shrink-0 w-[561.188px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative size-full">
        <Container25 />
        <Paragraph3 />
      </div>
...
function PrivateAccessPolicyDetailPage4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[79.594px]" data-name="PrivateAccessPolicyDetailPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[40px] not-italic text-[#364153] text-[14px] text-center top-0 whitespace-nowrap">View Profile</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[113.594px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center p-px relative size-full">
        <PrivateAccessPolicyDetailPage4 />
      </div>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="content-stretch flex h-[42.5px] items-center justify-between relative shrink-0 w-full" data-name="Container">
      <Container24 />
      <Button4 />
    </div>
  );
...
function Container22() {
  return (
    <div className="bg-white h-[84.5px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pb-px pt-[21px] px-[29px] relative rounded-[inherit] size-full">
        <Container23 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
    </div>
...
function PrivateAccessPolicyDetailPage() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-0 top-[96px] w-[1284px]" data-name="PrivateAccessPolicyDetailPage">
      <Button />
      <Container1 />
      <Container7 />
      <Container16 />
...
function T() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[64px] left-0 top-0 w-[1281px]" data-name="T6">
      <Container26 />
      <Container27 />
...
function Container() {
  return (
    <div className="flex-[1_0_0] h-[1071px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <PrivateAccessPolicyDetailPage />
        <T />
      </div>
    </div>
  );
...
function Section() {
  return <div className="h-[1071px] shrink-0 w-0" data-name="Section" />;
}

function RootLayoutContent() {
  return (
    <div className="bg-[#f9fafb] h-[1071px] relative shrink-0 w-full" data-name="RootLayoutContent">
...
function Body() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-0 top-0 w-[1536px]" data-name="Body">
      <RootLayoutContent />
    </div>
  );
}
...
function Text18() {
  return (
    <div className="h-[20px] relative shrink-0 w-[45.438px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px] whitespace-nowrap">Policies</p>
      </div>
    </div>
  );
}
...
function Union3() {
  return (
    <div className="absolute inset-[0_0.71%_1.45%_0]" data-name="Union">
...
export default function ViewPrivatePolicy() {
  return (
    <div className="bg-white relative size-full" data-name="View private policy">
      <Body />
      <SecondaryNav />
      <PrimaryNav />
    </div>
