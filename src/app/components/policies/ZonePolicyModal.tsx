...
import { ChevronLeft, Edit2, Copy, Trash2, Shield, Laptop, Globe, Lock } from 'lucide-react';
...
export function ZonePolicyModal({ policy, isOpen, onClose, onDelete }: ZonePolicyModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[544px] p-0 gap-0 bg-white overflow-hidden flex flex-col">
        {/* Header Section */}
        <div className="p-6 pb-5 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <Badge className="bg-[#16a34a] text-white px-3 py-0.5 text-xs font-medium hover:bg-[#16a34a] rounded-full">
                Active
              </Badge>
          ...
          <div className="bg-[#f9fafb] border border-[#e5e7eb] rounded-lg p-4">
            ...
            <p className="text-sm text-[#364153] leading-5">
              ...
              <span className="font-semibold text-[#101828]">Employee Zone</span> targeting{' '}
              <span className="font-semibold text-[#101828]">Internet</span>.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-[#364153] font-medium">192.168.1.0/24</span>
                </div>
                <div className="flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-[#364153]">Any</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-2 flex items-center justify-center -my-2">
              <div className="flex items-center gap-3">
                <div className="h-px bg-[#22c55e] w-24"></div>
                <Badge className="bg-[#f0fdf4] border border-[#b9f8cf] text-[#008236] px-3 py-1 text-xs font-medium hover:bg-[#f0fdf4] rounded-lg">
                  Allow
                </Badge>
                <div className="h-px bg-[#22c55e] w-24"></div>
              </div>
            ...
            <div className="col-start-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-xs text-[#6a7282]">Ports:</span>
                  <span className="text-xs text-[#364153]">22, 50-250</span>
                </div>
              </div>
            </div>
          </div>
