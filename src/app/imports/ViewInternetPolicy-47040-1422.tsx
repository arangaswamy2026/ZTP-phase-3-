import svgPaths from "./svg-9u1p46tb8v";
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_47040_1473)" id="Icon">
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[842px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[20px] min-h-px min-w-px not-italic relative text-[#101828] text-[15px]">Action</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="bg-[#dcfce7] h-[28px] relative rounded-[6px] shrink-0 w-[55.922px]" data-name="Text">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[11px] py-[5px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#16a34a] text-[13px] whitespace-nowrap">Allow</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="bg-white h-[102px] relative rounded-[12px] shrink-0 w-full" data-name="Container">
...
function Container12() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[9px] py-[4px] relative shrink-0" data-name="Container">
      ...
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">{`Users: `}</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">Alice, John</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">Engineering</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <div className="relative rounded-[8px] shrink-0 w-[129px]">
...
function Container17() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[9px] py-[4px] relative shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-l border-solid border-t inset-0 pointer-events-none" />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">{`Applications: `}</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex items-center justify-center pl-[4px] pr-[9px] py-[4px] relative rounded-br-[10px] rounded-tr-[10px] shrink-0" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">Envoy, Box</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col h-[24px] items-start relative shrink-0 w-full">
      <div className="relative rounded-[8px] shrink-0 w-[171px]">
        <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit] w-full">
          <Container17 />
          <Container18 />
        </div>
...
function Container11() {
  return (
    <div className="h-[240px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pl-[28px] py-[20px] relative size-full">
        <Frame2 />
      </div>
    </div>
  );
...
function Container10() {
  return (
    <div className="bg-white h-[138px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
...
function Container19() {
  return (
    <div className="bg-white h-[224px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container20 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Icon23() {
  return (
    <div className="absolute left-[11px] size-[14px] top-[8px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_47040_796)" id="Icon">
...
function Icon24() {
  return (
    <div className="absolute left-[11px] size-[14px] top-[8px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_47040_856)" id="Icon">
...
function Container24() {
  return (
    <div className="bg-white h-[966px] relative rounded-[12px] shrink-0 w-[900px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container25 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Sc() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1480px] items-center left-0 top-0 w-[1476px]" data-name="SC">
      <Button />
      <Container1 />
      <Frame1 />
      <Container19 />
...
function Frame() {
  return (
    <div className="absolute h-[1744px] left-0 overflow-x-clip overflow-y-auto top-[96px] w-[1476px]">
      <Sc />
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex flex-col h-[64px] items-start left-0 top-0 w-[1476px]">
      <T />
    </div>
  );
}
...
function Container() {
  return (
    <div className="flex-[1_0_0] h-[1840px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Frame />
        <Frame11 />
      </div>
...
function C() {
  return (
    <div className="bg-[#f9fafb] h-[1886px] relative shrink-0 w-full" data-name="c5">
...
function Body() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-0 top-[0.43px] w-[1728px]" data-name="Body">
      <C />
    </div>
  );
}
...
function Union1() {
  return (
    <div className="absolute inset-[0_0.69%_0.64%_0]" data-name="Union">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.5976 27.6428">
        <g id="Union">
...
function Subtract() {
  return (
    <div className="absolute inset-[0_0.87%_3.08%_0]" data-name="Subtract">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.5986 24.4203">
        <g id="Subtract">
...
export default function ViewInternetPolicy() {
  return (
    <div className="bg-white relative size-full" data-name="View internet policy">
      <Body />
      <O />
      <Component />
    </div>
